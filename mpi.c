...
// Description  : Task-3 Paralle_MPI_Version								//
// WS17-18 Rostock Universität										//
// Notes: 	1- 	input image should be gray scale						//
//		2- 	Below are the steps using Intel	Compiler					//
//			$ mpicc <fileName.c> -lpng -o <excutionNameFile>				//
//			$ mpirun -np <numberOfNodes> ./<excutionNameFile> <nameOfTestImage.png>		//
//		3-	Output image is output_mpi.png saved in the same directory			//
//======================================================================================================//
